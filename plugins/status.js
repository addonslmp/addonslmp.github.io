...
(function() {    
	...
	var I18N = {
    series: { ru: 'Сериал', uk: 'Серіал', en: 'Series' },
    ...
    function init() {      
        ...
        function addStatusBadge(status, cardView) {    
            ...
            if (status === 'ended') {    
                ...
                statusElement.textContent = t('ended');    
